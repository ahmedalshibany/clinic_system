window.translations = {
    en: {
        ...
        revenueTrend: "Revenue trend over last 6 months",
        // Time filter translations
        filterBy: "Filter by:",
        allTime: "All Time",
        thisWeek: "This Week",
        today: "Today",
        // Dashboard i18n keys for nurse/receptionist
        appointmentsToday: "Appointments Today",
        waitingRoom: "Waiting Room",
        thisMonth: "This Month",
        billingActionRequired: "Billing Action Required",
        thereAre: "There are",
        completedAppointmentsReady: "completed appointments ready for invoicing.",
        goToBilling: "Go to Billing",
        allCaughtUp: "All Caught Up!",
        noPendingBilling: "No pending billing actions required at this time.",
        triageQueue: "Triage Queue (To Vitals)",
        timeTable: "Time",
        patientName: "Patient Name",
        action: "Action",
        recordVitals: "Record Vitals",
        noPatientsInTriage: "Thinking... No patients in triage queue.",
        ...
        clickToAddUser: "Click 'Add User' to get started!",
        clickToAddService: "Click 'Add Service' to get started!",
        ...
        confirmDeleteMedicalRecord: "Are you sure you want to delete this medical record?",
        confirmDeleteFile: "Are you sure you want to delete this file?",
        confirmDeleteNotification: "Are you sure you want to delete all notifications?",
        confirmDeleteSingleNotification: "Delete this notification?",
        confirmDeleteLeave: "Are you sure?",
        confirmCancelAppt: "Are you sure you want to cancel this appointment?",
        confirmToggleUser: "Are you sure you want to change this user's status?",
        ...
        tryAdjustSearch: "Try adjusting your search term",
        noPatientsYet: "No patients yet",
        addPatientPrompt: 'Click "Add Patient" to get started!',
        failedLoadPatients: "Failed to load patients",
        failedLoadHistory: "Failed to load patient history",
        failedExport: "Failed to export data",
        failedLoadDoctors: "Failed to load doctors",
        noDoctorsYet: "No doctors yet",
        addDoctorPrompt: 'Click "Add Doctor" to get started!',
    ...
    ar: {
        ...
        revenueTrend: "اتجاه الإيرادات خلال آخر 6 أشهر",
        // Time filter translations
        filterBy: "تصفية حسب:",
        allTime: "كل الوقت",
        ...
        thisMonth: "هذا الشهر",
        billingActionRequired: "إجراء الفوترة مطلوب",
        thereAre: "هناك",
        completedAppointmentsReady: "مواعيد مكتملة جاهزة للفوترة",
        goToBilling: "الذهاب للفوترة",
        allCaughtUp: "كل شيء محدث!",
        noPendingBilling: "لا توجد إجراءات فوترة معلقة حالياً.",
        triageQueue: "طابور الفرز (للعلامات الحيوية)",
        timeTable: "الوقت",
        patientName: "اسم المريض",
        action: "الإجراء",
        recordVitals: "تسجيل العلامات الحيوية",
        noPatientsInTriage: "لا يوجد مرضى في طابور الفرز.",
        ...
        clickToAddUser: "انقر على 'إضافة مستخدم' للبدء!",
        clickToAddService: "انقر على 'إضافة خدمة' للبدء!",
        ...
        confirmDeleteNotification: "هل أنت متأكد من حذف جميع الإشعارات؟",
        confirmDeleteSingleNotification: "حذف هذا الإشعار؟",
        confirmDeleteLeave: "هل أنت متأكد؟",
        confirmCancelAppt: "هل أنت متأكد من إلغاء هذا الموعد؟",
        confirmToggleUser: "هل أنت متأكد من تغيير حالة هذا المستخدم؟",
        confirmResetPassword: "هل أنت متأكد من إعادة تعيين كلمة المرور؟",
        ...
        operationalReports: "التقارير التشغيلية",
        revenueReport: "تقرير الإيرادات",
        revenueReportDesc: "تفاصيل الدخل بمرور الوقت.",
        incomeByDoctor: "الدخل حسب الطبيب",
        incomeByDoctorDesc: "أداء الأرباح لكل ممارس.",
        salesByService: "المبيعات حسب الخدمة",
        salesByServiceDesc: "أفضل خدمات العيادة أداءً.",
        outstandingReport: "المستحقات",
        outstandingReportDesc: "الفواتير والديون غير المدفوعة.",
        ...
        systemPrefDesc: "اللغة، الوقت، العملة",
        apptSettings: "المواعيد",
        apptSettingsDesc: "المواعيد، الفواصل، القواعد",
        invSettings: "الفواتير",
        invSettingsDesc: "الضريبة، البادئات، الشروط",
        clinicInfoSection: "معلومات العيادة",
        clinicLogo: "شعار العيادة",
        logoDimensions: "الحجم الموصى به: 300x100px. الحجم الأقصى: 2 ميجابايت.",
        clinicNameEn: "اسم العيادة (إنجليزي)",
        clinicNameAr: "اسم العيادة (عربي)",
        address: "العنوان",
        phone: "رقم الهاتف",
        ...
        apptSettingsSection: "إعدادات المواعيد",
        slotDuration: "مدة الموعد الافتراضية (دقائق)",
        bufferTime: "فاصل بين المواعيد",
        none: "لا يوجد",
        advanceBooking: "أيام الحجز المسبق",
        advanceBookingDesc: "كم يوم مقدماً يمكن للمريض الحجز؟",
        allowSameDay: "السماح بالحجز في نفس اليوم",
        invConfigSection: "إعدادات الفاتورة",
        invPrefix: "بادئة رقم الفاتورة",
        taxRate: "معدل الضريبة الافتراضي (%)",
        taxRateWarning: "يجب أن يكون معدل الضريبة بين 0 و 100.",
        dueDays: "أيام الاستحقاق الافتراضية",
        paymentTerms: "شروط الدفع الافتراضية",
        bankDetails: "تفاصيل البنك / تعليمات الدفع",
        saveChanges: "حفظ التغييرات",
