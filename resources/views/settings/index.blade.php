            ...
            <div class="list-group list-group-flush" id="settingsTab" role="tablist">
                <a class="list-group-item list-group-item-action active py-3 border-0 d-flex align-items-center" 
                   id="clinic-tab" data-bs-toggle="list" href="#clinic" role="tab" aria-controls="clinic">
                    ...
                    <div>
                        <div class="fw-bold" data-i18n="clinicInfo">Clinic Info</div>
                        <small class="text-muted" data-i18n="clinicInfoDesc">Logo, Address, Contacts</small>
                    </div>
                </a>
                <a class="list-group-item list-group-item-action py-3 border-0 d-flex align-items-center" 
                   id="system-tab" data-bs-toggle="list" href="#system" role="tab" aria-controls="system">
                    ...
                    <div>
                        <div class="fw-bold" data-i18n="systemPref">System</div>
                        <small class="text-muted" data-i18n="systemPrefDesc">Language, Time, Currency</small>
                    </div>
                </a>
                <a class="list-group-item list-group-item-action py-3 border-0 d-flex align-items-center" 
                   id="appointments-tab" data-bs-toggle="list" href="#appointments" role="tab" aria-controls="appointments">
                    ...
                    <div>
                        <div class="fw-bold" data-i18n="apptSettings">Appointments</div>
                        <small class="text-muted" data-i18n="apptSettingsDesc">Slots, Buffers, Rules</small>
                    </div>
                </a>
                <a class="list-group-item list-group-item-action py-3 border-0 d-flex align-items-center" 
                   id="invoices-tab" data-bs-toggle="list" href="#invoices" role="tab" aria-controls="invoices">
                    ...
                    <div>
                        <div class="fw-bold" data-i18n="invSettings">Invoices</div>
                        <small class="text-muted" data-i18n="invSettingsDesc">Tax, Prefixes, Terms</small>
                    </div>
                </a>
            </div>
        </div>
        ...
        <form action="{{ route('settings.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <div class="row g-3">
                                ...
                                <div class="col-12 mb-3">
                                    <label class="form-label fw-bold" data-i18n="clinicLogo">Clinic Logo</label>
                                    ...
                                    <div class="form-text" data-i18n="logoDimensions">Recommended size: 300x100px. Max size: 2MB.</div>
                                </div>

                                <div class="col-md-6">
                                    <label class="form-label fw-bold" data-i18n="clinicNameEn">Clinic Name (English) <span class="text-danger">*</span></label>
                                    <input type="text" name="clinic_name" class="form-control" value="{{ $settings['clinic_name'] ?? '' }}" required>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label fw-bold" data-i18n="clinicNameAr">Clinic Name (Arabic)</label>
                                    <input type="text" name="clinic_name_ar" class="form-control" value="{{ $settings['clinic_name_ar'] ?? '' }}" dir="rtl">
                                </div>

                                <div class="col-12">
                                    <label class="form-label fw-bold" data-i18n="address">Address</label>
                                    <input type="text" name="clinic_address" class="form-control" value="{{ $settings['clinic_address'] ?? '' }}">
                                </div>

                                <div class="col-md-6">
                                    <label class="form-label fw-bold" data-i18n="phone">Phone Number</label>
                                    <input type="text" name="clinic_phone" class="form-control" value="{{ $settings['clinic_phone'] ?? '' }}">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label fw-bold" data-i18n="email">Email Address</label>
                                    <input type="email" name="clinic_email" class="form-control" value="{{ $settings['clinic_email'] ?? '' }}">
                                </div>
                                
                                <div class="col-md-6">
                                    <label class="form-label fw-bold" data-i18n="website">Website</label>
                                    <input type="url" name="clinic_website" class="form-control" value="{{ $settings['clinic_website'] ?? '' }}" placeholder="https://">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label fw-bold" data-i18n="taxNumber">Tax Registration Number</label>
                ...
                <div class="tab-pane fade" id="system" role="tabpanel" aria-labelledby="system-tab">
                    <div class="card border-0 shadow-sm">
                        ...
                        <div class="card-body">
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <label class="form-label fw-bold" data-i18n="defaultLang">Default Language</label>
                                    <select name="default_language" class="form-select">
                                        <option value="en" {{ ($settings['default_language'] ?? 'en') == 'en' ? 'selected' : '' }} data-i18n="english">English</option>
                                        <option value="ar" {{ ($settings['default_language'] ?? 'en') == 'ar' ? 'selected' : '' }} data-i18n="arabic">Arabic</option>
                                    </select>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label fw-bold" data-i18n="timezone">Timezone</label>
                                ...
                                <div class="col-md-6">
                                    <label class="form-label fw-bold" data-i18n="dateFormat">Date Format</label>
                                ...
                                <div class="col-md-6">
                                    <label class="form-label fw-bold" data-i18n="timeFormat">Time Format</label>
                                ...
                                <div class="col-md-6">
                                    <label class="form-label fw-bold" data-i18n="currencyCode">Currency Code</label>
                                    <input type="text" name="currency" class="form-control" value="{{ $settings['currency'] ?? 'USD' }}" maxlength="3">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label fw-bold" data-i18n="currencySymbol">Currency Symbol</label>
                ...
                <div class="tab-pane fade" id="appointments" role="tabpanel" aria-labelledby="appointments-tab">
                    <div class="card border-0 shadow-sm">
                        ...
                        <div class="card-body">
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <label class="form-label fw-bold" data-i18n="slotDuration">Default Slot Duration (Minutes)</label>
                                ...
                                <div class="col-md-6">
                                    <label class="form-label fw-bold" data-i18n="bufferTime">Buffer Between Appointments</label>
                                    <select name="buffer_time" class="form-select">
                                        <option value="0" {{ ($settings['buffer_time'] ?? 0) == 0 ? 'selected' : '' }} data-i18n="none">None</option>
                                ...
                                <div class="col-md-6">
                                    <label class="form-label fw-bold" data-i18n="advanceBooking">Advance Booking Days</label>
                                    <input type="number" name="advance_booking_days" class="form-control" value="{{ $settings['advance_booking_days'] ?? 30 }}" min="1" max="365">
                                    <div class="form-text" data-i18n="advanceBookingDesc">How many days in advance can a patient book?</div>
                                </div>
                                ...
                                <div class="col-md-6 d-flex align-items-center">
                                    <div class="form-check form-switch mt-3">
                                        ...
                                        <label class="form-check-label fw-bold" for="allowSameDay" data-i18n="allowSameDay">Allow Same-Day Booking</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="tab-pane fade" id="invoices" role="tabpanel" aria-labelledby="invoices-tab">
                    <div class="card border-0 shadow-sm">
                        ...
                        <div class="card-body">
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <label class="form-label fw-bold" data-i18n="invPrefix">Invoice Number Prefix</label>
                                    <input type="text" name="invoice_prefix" class="form-control" value="{{ $settings['invoice_prefix'] ?? 'INV-' }}">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label fw-bold" data-i18n="taxRate">Default Tax Rate (%)</label>
                                    <input type="number" name="tax_rate" class="form-control" value="{{ $settings['tax_rate'] ?? 0 }}" min="0" max="100" step="0.01">
                                    <span class="text-danger" data-i18n="taxRateWarning">The tax rate must be between 0 and 100.</span>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label fw-bold" data-i18n="dueDays">Default Due Days</label>
                                    <input type="number" name="default_due_days" class="form-control" value="{{ $settings['default_due_days'] ?? 30 }}">
                                </div>
                                
                                <div class="col-12">
                                    <label class="form-label fw-bold" data-i18n="paymentTerms">Default Payment Terms</label>
                                    <textarea name="payment_terms" class="form-control" rows="3">{{ $settings['payment_terms'] ?? 'Payment is due within 30 days.' }}</textarea>
                                </div>
                                <div class="col-12">
                                    <label class="form-label fw-bold" data-i18n="bankDetails">Bank Details / Payment Instructions</label>
            ...
            <div class="d-flex justify-content-end mt-4">
                <button type="submit" class="btn btn-primary px-5 btn-lg">
                    <i class="fas fa-save me-2"></i> <span data-i18n="saveChanges">Save Changes</span>
                </button>
            </div>
        </form>
    </div>
