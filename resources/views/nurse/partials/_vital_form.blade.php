            ...
            <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: var(--space-lg);">
                ...
                <div>
                    ...
                    <div style="display: grid; grid-template-columns: 1fr auto 1fr; gap: 2px; align-items: center;">
                        <input type="number" name="bp_systolic" value="{{ old('bp_systolic') }}" required min="50" max="250" placeholder="120" style="width: 100%; padding: var(--space-sm) var(--space-md); background: var(--input-bg); border: 1px solid var(--border-hairline); border-radius: var(--radius-sm); color: var(--text-primary); font-size: var(--text-sm); outline: none; text-align: center; transition: border-color var(--duration-fast) var(--ease-out);" onfocus="this.style.borderColor='var(--secondary)';" onblur="this.style.borderColor=''">
                        <span style="color: var(--text-muted); font-size: var(--text-sm); padding: 0 2px;">/</span>
                        <input type="number" name="bp_diastolic" value="{{ old('bp_diastolic') }}" required min="30" max="150" placeholder="80" style="width: 100%; padding: var(--space-sm) var(--space-md); background: var(--input-bg); border: 1px solid var(--border-hairline); border-radius: var(--radius-sm); color: var(--text-primary); font-size: var(--text-sm); outline: none; text-align: center; transition: border-color var(--duration-fast) var(--ease-out);" onfocus="this.style.borderColor='var(--secondary)';" onblur="this.style.borderColor=''">
                    </div>
                </div>
