...
@section('page-title', __('Medical Records'))
...
<div class="row mb-4">
    <div class="col-12">
        <form method="GET" class="row g-3 align-items-end">
            <div class="col-md-3">
                <label class="form-label small">{{ __('Patient') }}</label>
            ...
            <div class="col-md-3">
                <label class="form-label small">{{ __('Doctor') }}</label>
            ...
            <div class="col-md-2">
                ...
                <input type="text" name="search" class="form-control" placeholder="{{ __('Diagnosis...') }}" value="{{ request('search') }}">
            </div>
            <div class="col-md-2 d-flex gap-2">
                <button type="submit" class="btn btn-primary w-100"><i class="fas fa-filter"></i> {{ __('Filter') }}</button>
        ...
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0">
                ...
                <tbody>
                    ...
                    @empty
                    <tr>
                        <td colspan="6" class="text-center py-4 text-muted">{{ __('No medical records found.') }}</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
