...
@section('title', __('messages.patientsEdit'))
@section('page-title', __('messages.patientsEdit'))
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-select" name="marital_status">
                                ...
                                <option value="single" {{ old('marital_status', $patient->marital_status) == 'single' ? 'selected' : '' }}>{{ __('messages.single') }}</option>
                                <option value="married" {{ old('marital_status', $patient->marital_status) == 'married' ? 'selected' : '' }}>{{ __('messages.married') }}</option>
                                <option value="divorced" {{ old('marital_status', $patient->marital_status) == 'divorced' ? 'selected' : '' }}>{{ __('messages.divorced') }}</option>
                                <option value="widowed" {{ old('marital_status', $patient->marital_status) == 'widowed' ? 'selected' : '' }}>{{ __('messages.widowed') }}</option>
                            </select>
                        </div>
                        ...
                        <div class="col-md-6">
                            <label class="form-label">{{ __('messages.patientStatus') }}</label>
                            <select class="form-select" name="status">
                                <option value="active" {{ old('status', $patient->status) == 'active' ? 'selected' : '' }}>{{ __('messages.active') }}</option>
                                <option value="inactive" {{ old('status', $patient->status) == 'inactive' ? 'selected' : '' }}>{{ __('messages.inactive') }}</option>
                                <option value="deceased" {{ old('status', $patient->status) == 'deceased' ? 'selected' : '' }}>{{ __('messages.deceased') }}</option>
                            </select>
                        </div>
                    </div>
                </div>
